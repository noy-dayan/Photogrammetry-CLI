...
def extract_frames(video_path, output_folder, max_frames=100, max_overlap_percentage=6, ssim_threshold=0.95):
    ...
    pbar = tqdm(total=max_frames, desc="Extracting frames", position=0, leave=True, bar_format='\033[35m{desc}:\033[0m \033[1;37m{percentage:3.0f}%|{bar}|\033[0m \033[37m[{elapsed}<{remaining}]\033[0m')
